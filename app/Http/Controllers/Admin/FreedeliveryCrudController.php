...
use App\Http\Requests\FooddeliveryRequest as StoreRequest;
use App\Http\Requests\FooddeliveryRequest as UpdateRequest;

class FreedeliveryCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Freedelivery');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/freedeliveries');
        $this->crud->setEntityNameStrings('Free delivery Coupon', 'Free delivery Coupons');
        ...
        */
        ...
        $this->crud->addColumns([
            ...
            ['name' => 'valid_through', 'label' => 'Validity'],
