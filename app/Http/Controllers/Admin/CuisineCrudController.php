...
use App\Http\Requests\CuisineRequest as StoreRequest;
use App\Http\Requests\CuisineRequest as UpdateRequest;

class CuisineCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/cuisines');
