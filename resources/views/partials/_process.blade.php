            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We"ve got your covered with menus from over {{ App\Models\Restaurant::count() }} delivery restaurants online.</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Pay by Cash on delivery , Card or Netbanking</p>
                    </div>
                </div>
            </div>
        </section>