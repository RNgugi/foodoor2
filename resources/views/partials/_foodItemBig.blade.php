...
<div class="content">
    ...
    <div class="price-btn-block"> <span class="price">&#8377  250 <small>/ 2 persons</small></span> <a href="/restaurants/{{$restaurant->id}}" class="btn theme-btn-dash " style="margin-top: 20px;">Order Now</a> </div>
</div>
